...
void ExampleFIRCall(void)
{
 ...
 FILE *OutPutFile;
 OutPutFile = fopen("FIRCoeff.txt","w");
...
/*
 BasicFIR() generates the impulse response for a rectangular low pass, high pass,
 ...
 switch(PassType)
  {
   ...
   case firALLPASS: // Trivial, but shows how an fir all pass (delay) is done.
