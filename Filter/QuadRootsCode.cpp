...
//---------------------------------------------------------------------------
// Interface used in the Kit QuadRootsCode.cpp
int QuadCubicRoots(int N, double *Coeff, double *RootsReal, double *RootsImag)
{
 ...
 // Move the roots from the long double arrays to the arrays in the function call.
 // We used long double variables in the algorithm for best accuracy.
 // if N==0 all zeros are returned (we initialized RealRoot and ImagRoot to 0).
