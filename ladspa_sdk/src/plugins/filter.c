...
typedef struct {
  ...
  LADSPA_Data m_fSampleRate;	//SampleRate
  LADSPA_Data m_fTwoPiOverSampleRate;	//TwoPiOverSampleRate
  ...
  LADSPA_Data * m_pfCutoff;	//cutoff
  LADSPA_Data * m_pfInput;	//input
  LADSPA_Data * m_pfOutput;	//output
